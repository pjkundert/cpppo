...
** Installing
   ...
   To install 'cpppo' straight from the source repository using pip:
   : $ pip install git+https://github.com/pjkundert/cpppo.git
   : $ pip install git+https://github.com/pjkundert/greenery.git

   If you desire the --web :<port> option, install the web.py:
   : $ pip install web
