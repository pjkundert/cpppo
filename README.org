...
**** Writing Attributes Using =proxy.write= (alias for =.read=)
     ...
     The =.read= method (or its alias =.write=) support writing to CIP Attributes.  Simply append an
     equals sign, a CIP type in parentheses, and a comma-separated list of values to the parameter
     or Attribute name.
...
** Basic State Machines
   ...
   #+BEGIN_SRC ditaa :file abplus.png :cmdline -r -S
       +-----+ 'a' +-----+ 'b' +-----+ 'b'
       |  E  |---->|  A  |---->| (B) |----+
       +-----+     +-----+     +-----+    |
                                  ^       |
...
** Composite Machines
   ...
   #+BEGIN_SRC ditaa :file abplus_csv.png :cmdline -r -S
                          +------------------------------+
                          |                              |
                          v                              |
       +----------------------------------------+        | None
...
** Machines from Regular Expressions
   ...
   #+BEGIN_SRC ditaa :file abplus_regex.png :cmdline -r -S
                        +--------------------------------+
                        |                                |
                        v                                | 'a'
       +-----+ 'a'   +-----+ 'b'   +-----+ ','   +-----+ |
