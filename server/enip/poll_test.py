...
def test_powerflex_poll_failure():
    ...
    def null_server( conn, addr, server=None ):
        ...
        conn.send( b'o\x00(\x00\x03\xfd;\x1f\x00\x00\x00\x000\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x02\x00\x00\x00\x00\x00\xb2\x00\x18\x00\x8e\x00\x00\x00\x13PowerFlex/20-COMM-E' )
        conn.close()
